...
Feb1n2 <- rbind(Feb1, Feb2)
     ...
     ## Again, ended up not needing the date/time conversion of this code:
...
## axis() sets proper scale labels, the key observation is that each subset
## taken separately above has 1440; Day transition is at that point
## Noted using dim(Feb1), dim(Feb2), useful because "Sat" had to be added anyway
